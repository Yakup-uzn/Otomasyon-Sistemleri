...
CREATE TABLE `mudur` (
  ...
  `MUDUR_AD` varchar(20) DEFAULT NULL,
  `MUDUR_SOYAD` varchar(20) DEFAULT NULL,
  `MUDUR_TEL` varchar(12) DEFAULT NULL,
  `MUDUR_MAIL` varchar(40) DEFAULT NULL,
  `MUDUR_SIFRE` varchar(20) DEFAULT NULL,
  PRIMARY KEY (`MUDUR_ID`),
  KEY `fk_mudur` (`OKUL_ID`),
  CONSTRAINT `fk_mudur` FOREIGN KEY (`OKUL_ID`) REFERENCES `okul` (`OKUL_ID`)
