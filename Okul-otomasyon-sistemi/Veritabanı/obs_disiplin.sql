...
CREATE TABLE `disiplin` (
  `DISIPLIN_ID` int NOT NULL AUTO_INCREMENT,
  `OGRENCI_ID` int DEFAULT NULL,
  `OGRENCI_AD` varchar(20) DEFAULT NULL,
  `OGRENCI_SOYAD` varchar(20) DEFAULT NULL,
  `ISLEDIGI_SUC` varchar(20) DEFAULT NULL,
  `CEZA` varchar(30) DEFAULT NULL,
