...
CREATE TABLE `veli` (
  ...
  `VELI_AD` varchar(20) DEFAULT NULL,
  `VELI_SOYAD` varchar(20) DEFAULT NULL,
  `VELI_TEL` varchar(12) DEFAULT NULL,
  `VELI_MAIL` varchar(40) DEFAULT NULL,
  `VELI_SIFRE` varchar(20) DEFAULT NULL,
  PRIMARY KEY (`VELI_ID`)
