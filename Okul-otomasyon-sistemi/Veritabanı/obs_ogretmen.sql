...
CREATE TABLE `ogretmen` (
  ...
  `OGRETMEN_AD` varchar(20) DEFAULT NULL,
  `OGRETMEN_SOYAD` varchar(20) DEFAULT NULL,
  `OGRETMEN_TEL` varchar(12) DEFAULT NULL,
  `OGRETMEN_MAIL` varchar(40) DEFAULT NULL,
  `OGRETMEN_SIFRE` varchar(20) DEFAULT NULL,
  PRIMARY KEY (`OGRETMEN_ID`),
  KEY `fk_ogretmen` (`OKUL_ID`),
  CONSTRAINT `fk_ogretmen` FOREIGN KEY (`OKUL_ID`) REFERENCES `okul` (`OKUL_ID`)
