...
--
-- Table structure for table `ogretmensikayet`
--

DROP TABLE IF EXISTS `ogretmensikayet`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `ogretmensikayet` (
  `SIKAYET_ID` int NOT NULL AUTO_INCREMENT,
  `OLUSTURMA_TARIH` datetime DEFAULT NULL,
  `SIKAYET_ICERIK` varchar(200) DEFAULT NULL,
  `OGRETMEN_YORUM` varchar(100) DEFAULT NULL,
